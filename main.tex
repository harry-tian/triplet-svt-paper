...
\ifcomments
    ...
    \newcommand\harry[1]{\textcolor{purple}{[HT: #1]}}
...
\icmltitlerunning{Towards Effective Case-Based Decision Support with Human-Compatible Representations}
...
\icmltitle{Towards Effective Case-Based Decision Support \\
