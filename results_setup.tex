...
% Empirically tuning $\lambda$ confirms this hypothesis (see the supplementary materials). 
For the main paper, we present results with one value of $\lambda$ for each experiment. More details about hyperparameter tuning can be found in the supplementary materials.
