...
\begin{itemize}[itemsep=0pt, topsep=0pt, leftmargin=*]
  ...
  \item Decision support (``\textbf{NINO}''). Following \secref{sec:formulation}, we retrieve the nearest neighbors from each class. We use the accuracy of humans (or synthetic agents) as the measure of effective decision support while preserving human agency.
