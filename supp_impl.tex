...
We first encode image inputs using a Convolutional Neural Network (CNN), and then project the output into an high-dimension representation space with a projection head made of multi-layer perceptron (MLP). 
...
Hyperparameters will be reported in \ref{sec:supp_syn} for models in the synthetic experiments and in \ref{sec:supp_human} for models in the human experiments.
