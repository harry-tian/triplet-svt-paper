...
% \subsection{Additional results for square decision boundary}
...
% \paragraph{Table 1 with error bar.}
% \han{Table 1 ambiguous reference. Writing out the caption here.}
