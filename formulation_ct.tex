...
Given a classification model $h$, the representation model in justification and decision support is a byproduct derived from $h$, which is the last layer before the classification head.
