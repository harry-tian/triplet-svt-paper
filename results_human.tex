...
\harry{we can also remove these 2 sentences?} BM is a binary classification problem and each class contains four species (see appendix for examples). We randomly split the dataset following 60\%:20\%:20\% ratio (120/40/40 images).
...
\harry{can prob remove the next sentence?} An screenshot of the interface can be found in the appendix.
...
\begin{table}[t]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.55\textwidth]{figures/bm/prolific/decision.pdf}
