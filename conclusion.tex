...
To address this issue, we propose a multi-task learning method (\mtl) to combine two sources of supervision: labeled examples for classification, and triplets of human similarity judgments, and validate its effectiveness.
