...
In decision support, the nearest neighbors in each class are selected to provide evidence to allow humans to make decisions while preserving human agency.
...
\caption{Nearest neighbor retrieved by the model representation might not align with human similarity judgment. 
