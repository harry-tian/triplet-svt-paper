...
%       \includegraphics[width=\textwidth]{figures/bm/species/ringlet}
%       \caption{Ringlet Butterfly}
%     \end{subfigure}
%     \begin{subfigure}{0.24\textwidth}
%         \includegraphics[width=\textwidth]{figures/bm/species/peacock}
%         \caption{Peacock Butterfly}
%     \end{subfigure}
%     \begin{subfigure}{0.24\textwidth}
%         \includegraphics[width=\textwidth]{figures/bm/species/caterpillar}
%         \caption{Caterpiller Moth}
%     \end{subfigure}
%     \begin{subfigure}{0.24\textwidth}
%         \includegraphics[width=\textwidth]{figures/bm/species/tiger}
%         \caption{Tiger Moth}
%     \end{subfigure}
